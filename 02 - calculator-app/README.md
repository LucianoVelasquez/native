...
La aplicación permitirá realizar operaciones aritméticas básicas (suma➕, resta➖, multiplicación✖️, división➗) a través de una interfaz de usuario intuitiva.
